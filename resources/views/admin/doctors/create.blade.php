            ...
            <div class="col-md-8">
                ...
                <form action="{{ route('admin.doctors.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <input name="photo" type="file" id="photo"
                                    ...
                                    style=" border-radius: 5px; background: #f7f7f7; text-align: center;">
                                @error('photo')
                            ...
                            <div class="col-md-4 d-flex align-items-center">
                                <img class="d-none doctor-photo img-thumbnail" id="photo-preview" src=""
                                    alt="" style="max-width: 100%; max-height: 220px">
                            </div>
                        </div>
                    </div>
                    {{-- PHOTO PREVIEW --}}
                    ...
                    <div class="d-flex justify-content-around gap-3">
                        ...
                        {{-- PERFORMANCES --}}
                        <div class="mb-3 w-100">
                            <label for="performance" class="form-label text-info">Prestationi *</label>
                    ...
                    <div class="mb-3 w-100">
                        <div class="row align-items-center">
                            ...
                            {{-- CV PREVIEW --}}
                            <div class="col-md-4 d-flex align-items-center">
                                <embed class="d-none doctor-cv " id="cv-preview" src="" type="application/pdf"
