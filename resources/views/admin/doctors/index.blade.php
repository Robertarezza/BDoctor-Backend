...
<div class="container ms-container-index">
    ...
    <div class="row">
        ...
        <div class="col-8">
            ...
            {{-- OPEN MODAL --}}
            <button type="submit" class="ms-openModalDelete btn btn-outline-danger"  title="Elimina"><i class="fa-solid fa-trash-can "></i></button>
            <a href="{{ route('admin.doctors.edit', ['doctor' => $doctor->id]) }}" class="btn btn-outline-warning" title="Modifica">
